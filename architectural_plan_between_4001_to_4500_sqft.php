...
<head>
    ...
    <title>Architect Design Package: between 4001 to 4500 Sq.Ft. Projects.</title>
        ...
        <div class="main-content">
            ...
            <div class="left-section">
                ...
                <div class="product-image-container">
                    <img src="https://raw.githubusercontent.com/aaadityapal/webp/refs/heads/main/4001-4500SQFT.webp"
                        alt="Architect Design Package: between 4001 to 4500 Sq.Ft. Projects.">
                </div>
            ...
            <div class="middle-section">
                <h1>Architect Design Package: between 4001 to 4500 Sq.Ft. Projects.</h1>

                <div class="product-description">
                    <h3>Product Details</h3>
                    <p>Get House plan as per your site Measurements for Area between 4001 Sq.Ft. to 4500 Sq.Ft. Projects</p>
                </div>
            ...
            <div class="right-section">
                <div class="price" id="dynamicPrice">₹27,999.00</div>
                        ...
                        <h3 class="section-title">Extra Floor to be Added:</h3>
                                ...
                                <span class="option-text">
                                    <span class="option-name">1</span>
                                                                            <span class="option-price">(+₹22,400.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                ...
                                <span class="option-text">
                                    <span class="option-name">2</span>
                                                                            <span class="option-price">(+₹44,800.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                ...
                                <span class="option-text">
                                    <span class="option-name">3</span>
                                                                            <span class="option-price">(+₹67,200.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                ...
                                <span class="option-text">
                                    <span class="option-name">4</span>
                                                                            <span class="option-price">(+₹89,600.00)</span>
                                                                    </span>
                            </label>
                                            </div>
                                ...
                                <span class="option-text">
                                    <span
                                        class="option-name">Front</span>
                                                                            <span class="option-price">(+₹9,250.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                <input type="checkbox" name="elevation"
    ...
    <script>
        ...
        function addToCart() {
            ...
            const newItem = {
                ...
                id: editingCartItemId ? editingCartItemId : 'plan_14_' + Date.now(),
                productId: 'plan_14',
                name: 'Architect Design Package: between 4001 to 4500 Sq.Ft. Projects.',
                image: 'https://raw.githubusercontent.com/aaadityapal/webp/refs/heads/main/4001-4500SQFT.webp',
            ...
            showCartNotification(
                'Architect Design Package: between 4001 to 4500 Sq.Ft. Projects.',
                'https://raw.githubusercontent.com/aaadityapal/webp/refs/heads/main/4001-4500SQFT.webp',
                options.totalPrice
            );
        }
