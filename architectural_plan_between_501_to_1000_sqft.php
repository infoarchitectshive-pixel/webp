...
<head>
    ...
    <title>Architect Design Package: between 501 to 1000 Sq.Ft. Projects.</title>
        ...
        <div class="main-content">
            ...
            <div class="left-section">
                ...
                <div class="product-image-container">
                    <img src="https://github.com/aaadityapal/webp/blob/main/501-1000SQFT.webp?raw=true"
                        alt="Architect Design Package: between 501 to 1000 Sq.Ft. Projects.">
                </div>
            ...
            <div class="middle-section">
                <h1>Architect Design Package: between 501 to 1000 Sq.Ft. Projects.</h1>

                <div class="product-description">
                    <h3>Product Details</h3>
                    <p>Get House plan as per your site Measurements for Area between 501 Sq.Ft. to 1000 Sq.Ft. Project.</p>
                </div>
            ...
            <div class="right-section">
                <div class="price" id="dynamicPrice">₹9,999.00</div>
                        ...
                        <h3 class="section-title">Extra Floor to be Added:</h3>
                                ...
                                <span class="option-text">
                                    <span class="option-name">1</span>
                                                                            <span class="option-price">(+₹8,000.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                ...
                                <span class="option-text">
                                    <span class="option-name">3</span>
                                                                            <span class="option-price">(+₹24,000.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                ...
                                <span class="option-text">
                                    <span class="option-name">4</span>
                                                                            <span class="option-price">(+₹32,000.00)</span>
                                                                    </span>
                            </label>
                                            </div>
                                ...
                                <span class="option-text">
                                    <span
                                        class="option-name">Front</span>
                                                                            <span class="option-price">(+₹6,000.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                <input type="checkbox" name="elevation"
                        ...
                        <h3 class="section-title">Vastu Incorporation:</h3>
                                ...
                                <span class="option-text">
                                    <span class="option-name">Vastu</span>
                                                                            <span class="option-price">(+₹1,250.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                ...
                                <span class="option-text">
                                    <span class="option-name">Scientific Vastu</span>
                                                                            <span class="option-price">(+₹12,000.00)</span>
                                                                    </span>
                            </label>
                                            </div>
    ...
    <script>
        ...
        function addToCart() {
            ...
            const newItem = {
                ...
                id: editingCartItemId ? editingCartItemId : 'plan_7_' + Date.now(),
                productId: 'plan_7',
                name: 'Architect Design Package: between 501 to 1000 Sq.Ft. Projects.',
                image: 'https://github.com/aaadityapal/webp/blob/main/501-1000SQFT.webp?raw=true',
            ...
            showCartNotification(
                'Architect Design Package: between 501 to 1000 Sq.Ft. Projects.',
                'https://github.com/aaadityapal/webp/blob/main/501-1000SQFT.webp?raw=true',
                options.totalPrice
            );
        }
