...
<head>
    ...
    <title>Architect Design Package: between 4501 to 5000 Sq.Ft. Projects.</title>
        ...
        <div class="main-content">
            ...
            <div class="left-section">
                ...
                <div class="product-image-container">
                    <img src="https://raw.githubusercontent.com/aaadityapal/webp/refs/heads/main/4501-5000SQFT.webp"
                        alt="Architect Design Package: between 4501 to 5000 Sq.Ft. Projects.">
                </div>
            ...
            <div class="middle-section">
                <h1>Architect Design Package: between 4501 to 5000 Sq.Ft. Projects.</h1>

                <div class="product-description">
                    <h3>Product Details</h3>
                    <p>Get House plan as per your site Measurements for Area between 4501 Sq.Ft. to 5000 Sq.Ft. Projects</p>
                </div>
            ...
            <div class="right-section">
                <div class="price" id="dynamicPrice">₹28,999.00</div>
                        ...
                        <h3 class="section-title">Extra Floor to be Added:</h3>
                                ...
                                <span class="option-text">
                                    <span class="option-name">1</span>
                                                                            <span class="option-price">(+₹23,200.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                ...
                                <span class="option-text">
                                    <span class="option-name">2</span>
                                                                            <span class="option-price">(+₹46,400.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                ...
                                <span class="option-text">
                                    <span class="option-name">3</span>
                                                                            <span class="option-price">(+₹69,600.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                ...
                                <span class="option-text">
                                    <span class="option-name">4</span>
                                                                            <span class="option-price">(+₹92,800.00)</span>
                                                                    </span>
                            </label>
                                            </div>
                                ...
                                <span class="option-text">
                                    <span
                                        class="option-name">Front</span>
                                                                            <span class="option-price">(+₹9,500.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                <input type="checkbox" name="elevation"
                        ...
                        <h3 class="section-title">Vastu Incorporation:</h3>
                                ...
                                <span class="option-text">
                                    <span class="option-name">Vastu</span>
                                                                            <span class="option-price">(+₹10,000.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                ...
                                <span class="option-text">
                                    <span class="option-name">Scientific Vastu</span>
                                                                            <span class="option-price">(+₹100,000.00)</span>
                                                                    </span>
                            </label>
                                            </div>
    ...
    <script>
        ...
        function addToCart() {
            ...
            const newItem = {
                ...
                id: editingCartItemId ? editingCartItemId : 'plan_15_' + Date.now(),
                productId: 'plan_15',
                name: 'Architect Design Package: between 4501 to 5000 Sq.Ft. Projects.',
                image: 'https://raw.githubusercontent.com/aaadityapal/webp/refs/heads/main/4501-5000SQFT.webp',
            ...
            showCartNotification(
                'Architect Design Package: between 4501 to 5000 Sq.Ft. Projects.',
                'https://raw.githubusercontent.com/aaadityapal/webp/refs/heads/main/4501-5000SQFT.webp',
                options.totalPrice
            );
        }
