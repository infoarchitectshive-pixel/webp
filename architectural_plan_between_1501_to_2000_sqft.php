...
<head>
    ...
    <title>Architect Design Package: between 1501 to 2000 Sq.Ft. Projects.</title>
        ...
        <div class="main-content">
            ...
            <div class="left-section">
                ...
                <div class="product-image-container">
                    <img src="https://raw.githubusercontent.com/aaadityapal/webp/refs/heads/main/1501-2000SQFT.webp"
                        alt="Architect Design Package: between 1501 to 2000 Sq.Ft. Projects.">
                </div>
            ...
            <div class="middle-section">
                <h1>Architect Design Package: between 1501 to 2000 Sq.Ft. Projects.</h1>

                <div class="product-description">
                    <h3>Product Details</h3>
                    <p>Get House plan as per your site Measurements for Area between 1501 Sq.Ft.to 2000 Sq.Ft. Projects.</p>
                </div>
            ...
            <div class="right-section">
                <div class="price" id="dynamicPrice">₹16,099.00</div>
                        ...
                        <h3 class="section-title">Extra Floor to be Added:</h3>
                                ...
                                <span class="option-text">
                                    <span class="option-name">1</span>
                                                                            <span class="option-price">(+₹12,900.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                ...
                                <span class="option-text">
                                    <span class="option-name">2</span>
                                                                            <span class="option-price">(+₹25,800.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                ...
                                <span class="option-text">
                                    <span class="option-name">3</span>
                                                                            <span class="option-price">(+₹38,700.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                ...
                                <span class="option-text">
                                    <span class="option-name">4</span>
                                                                            <span class="option-price">(+₹51,600.00)</span>
                                                                    </span>
                            </label>
                                            </div>
                                ...
                                <span class="option-text">
                                    <span
                                        class="option-name">Front</span>
                                                                            <span class="option-price">(+₹7,250.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                <input type="checkbox" name="elevation"
    ...
    <script>
        ...
        function addToCart() {
            ...
            const newItem = {
                ...
                id: editingCartItemId ? editingCartItemId : 'plan_9_' + Date.now(),
                productId: 'plan_9',
                name: 'Architect Design Package: between 1501 to 2000 Sq.Ft. Projects.',
                image: 'https://raw.githubusercontent.com/aaadityapal/webp/refs/heads/main/1501-2000SQFT.webp',
            ...
            showCartNotification(
                'Architect Design Package: between 1501 to 2000 Sq.Ft. Projects.',
                'https://raw.githubusercontent.com/aaadityapal/webp/refs/heads/main/1501-2000SQFT.webp',
                options.totalPrice
            );
        }
