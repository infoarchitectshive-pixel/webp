...
<head>
    ...
    <title>Architect Design Package: between 3501 to 4000 Sq.Ft. Projects.</title>
        ...
        <div class="main-content">
            ...
            <div class="left-section">
                ...
                <div class="product-image-container">
                    <img src="https://raw.githubusercontent.com/aaadityapal/webp/refs/heads/main/3501-4000SQFT.webp"
                        alt="Architect Design Package: between 3501 to 4000 Sq.Ft. Projects.">
                </div>
            ...
            <div class="middle-section">
                <h1>Architect Design Package: between 3501 to 4000 Sq.Ft. Projects.</h1>

                <div class="product-description">
                    <h3>Product Details</h3>
                    <p>Get House plan as per your site Measurements for Area between 3501 Sq.Ft. to 4000 Sq.Ft. Projects</p>
                </div>
            ...
            <div class="right-section">
                <div class="price" id="dynamicPrice">₹26,499.00</div>
                        ...
                        <h3 class="section-title">Extra Floor to be Added:</h3>
                                ...
                                <span class="option-text">
                                    <span class="option-name">1</span>
                                                                            <span class="option-price">(+₹21,200.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                ...
                                <span class="option-text">
                                    <span class="option-name">2</span>
                                                                            <span class="option-price">(+₹42,400.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                ...
                                <span class="option-text">
                                    <span class="option-name">3</span>
                                                                            <span class="option-price">(+₹63,600.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                ...
                                <span class="option-text">
                                    <span class="option-name">4</span>
                                                                            <span class="option-price">(+₹84,800.00)</span>
                                                                    </span>
                            </label>
                                            </div>
                                ...
                                <span class="option-text">
                                    <span
                                        class="option-name">Front</span>
                                                                            <span class="option-price">(+₹9,000.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                <input type="checkbox" name="elevation"
    ...
    <script>
        ...
        function addToCart() {
            ...
            const newItem = {
                ...
                id: editingCartItemId ? editingCartItemId : 'plan_13_' + Date.now(),
                productId: 'plan_13',
                name: 'Architect Design Package: between 3501 to 4000 Sq.Ft. Projects.',
                image: 'https://raw.githubusercontent.com/aaadityapal/webp/refs/heads/main/3501-4000SQFT.webp',
            ...
            showCartNotification(
                'Architect Design Package: between 3501 to 4000 Sq.Ft. Projects.',
                'https://raw.githubusercontent.com/aaadityapal/webp/refs/heads/main/3501-4000SQFT.webp',
                options.totalPrice
            );
        }
