...
<head>
    ...
    <title>Architect Design Package: between 3001 to 3500 Sq.Ft. Projects.</title>
        ...
        <div class="main-content">
            ...
            <div class="left-section">
                ...
                <div class="product-image-container">
                    <img src="https://github.com/aaadityapal/webp/blob/main/3001-3500SQFT.webp?raw=true"
                        alt="Architect Design Package: between 3001 to 3500 Sq.Ft. Projects.">
                </div>
            ...
            <div class="middle-section">
                <h1>Architect Design Package: between 3001 to 3500 Sq.Ft. Projects.</h1>

                <div class="product-description">
                    <h3>Product Details</h3>
                    <p>Get House plan as per your site Measurements for Area between 3001 Sq.Ft.to 3500 Sq.Ft. Projects</p>
                </div>
            ...
            <div class="right-section">
                <div class="price" id="dynamicPrice">₹22,999.00</div>
                        ...
                        <h3 class="section-title">Extra Floor to be Added:</h3>
                                ...
                                <span class="option-text">
                                    <span class="option-name">1</span>
                                                                            <span class="option-price">(+₹18,400.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                ...
                                <span class="option-text">
                                    <span class="option-name">2</span>
                                                                            <span class="option-price">(+₹36,800.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                ...
                                <span class="option-text">
                                    <span class="option-name">3</span>
                                                                            <span class="option-price">(+₹55,200.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                ...
                                <span class="option-text">
                                    <span class="option-name">4</span>
                                                                            <span class="option-price">(+₹73,600.00)</span>
                                                                    </span>
                            </label>
                                            </div>
                                ...
                                <span class="option-text">
                                    <span
                                        class="option-name">Front</span>
                                                                            <span class="option-price">(+₹8,500.00)</span>
                                                                    </span>
                            </label>
                                                    <label class="option-label">
                                <input type="checkbox" name="elevation"
    ...
    <script>
        ...
        function addToCart() {
            ...
            const newItem = {
                ...
                id: editingCartItemId ? editingCartItemId : 'plan_12_' + Date.now(),
                productId: 'plan_12',
                name: 'Architect Design Package: between 3001 to 3500 Sq.Ft. Projects.',
                image: 'https://github.com/aaadityapal/webp/blob/main/3001-3500SQFT.webp?raw=true',
            ...
            showCartNotification(
                'Architect Design Package: between 3001 to 3500 Sq.Ft. Projects.',
                'https://github.com/aaadityapal/webp/blob/main/3001-3500SQFT.webp?raw=true',
                options.totalPrice
            );
        }
